...
Очерёдность выполнения обработки:
...
### **Таблица `skipped_posts` (отклоненные посты, не дойдут до публикации в ТГ)**
```sql
skipped_posts:
